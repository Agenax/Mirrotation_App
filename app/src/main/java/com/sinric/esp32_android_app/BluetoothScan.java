...
public class BluetoothScan {
    ...
    private static BluetoothLeScanner mBluetoothAdapterNG;
    private static BluetoothScanCallBack mBluetoothScanCallBack;
    private static ScanCallback mLeScanCallbackNG;

    public static void startScan(boolean autoEnable, ScanCallback callBack) {
        mLeScanCallbackNG = callBack;
        if (!isBluetoothSupport(autoEnable)) {
            return;
        }
        try {
            if (mBluetoothAdapterNG != null) {
                //mBluetoothAdapter.startLeScan(mLeScanCallback);
                mBluetoothAdapterNG.startScan(mLeScanCallbackNG);
            }
                else {
